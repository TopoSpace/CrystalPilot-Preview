...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| dbu | B/full | acceptable | 0.0626 | 0.0447 | +0.0179 | 是 | — | s2 CIF↔fcf:是<br>s3 REPORT↔CIF:是<br>s4 checkCIF解释门:是<br>e 窥视干净:是<br>自洽:是<br>结论↔CIF:是<br>未决披露:3 条 | 是（交付即最佳，或差距在 0.01 以内） | 15 min | 7,209,480 | 154 | 0 | — | `250395d3` 是 | graded |
...
- rollout 记录 550 条；工具调用 154 次，其中出错 0 次；推理段 46 段
...
| `refine` | 5 | 0 | 0.0 | 2.4s | — |
| `situation_report` | 4 | 0 | 0.0 | 0.8s | — |
| `add_hydrogens` | 4 | 0 | 0.0 | 0.4s | — |
| `audit_reflection_data` | 3 | 0 | 0.0 | 0.1s | — |
| `run_shelxt` | 3 | 0 | 0.0 | 0.3s | — |
| `view_structure` | 3 | 0 | 0.0 | 1.4s | — |
...
| `get_geometry` | 2 | 0 | 0.0 | — | — |
| `run_shelxl` | 2 | 0 | 0.0 | 1.3s | — |
...
- `situation_report` 重复 1 次　参数 `{"render": false}`
- `audit_reflection_data` 重复 1 次　参数 `{}`
- `run_checkcif` 重复 1 次　参数 `{"cif": "CrystalPilot Results/task_20260904_144917/final.cif", "timeout_s": 420}`

**轮询（detach 任务的状态查询，按工具契约每 60-120 s 一次）**

- `run_shelxt` 轮询 `job_20260904_145124` 1 次
...
`read_skill` 5 次 5 种; `run_shelxt` 3 次 3 种
...
| `run_checkcif` | 2 | 8.1s |
| `refine` | 5 | 2.4s |
| `view_structure` | 3 | 1.4s |
| `run_shelxl` | 2 | 1.3s |
| `situation_report` | 4 | 0.8s |
| `add_hydrogens` | 4 | 0.4s |
...
| `audit_element_assignment` | 1 | 0.2s |
...
|---|---|---|---|---|---|---|---|---|
| `situation_report` | 1 | 0 | 0 | 0 | 1 | 4 | 0 | 0.0 |
